...
set_property PACKAGE_PIN N3 [get_ports {Negative_out}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Negative_out}]
...
##7 segment display
set_property PACKAGE_PIN W7 [get_ports {sev_seg_output[6]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {sev_seg_output[6]}]
set_property PACKAGE_PIN W6 [get_ports {sev_seg_output[5]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {sev_seg_output[5]}]
set_property PACKAGE_PIN U8 [get_ports {sev_seg_output[4]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {sev_seg_output[4]}]
set_property PACKAGE_PIN V8 [get_ports {sev_seg_output[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {sev_seg_output[3]}]
set_property PACKAGE_PIN U5 [get_ports {sev_seg_output[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {sev_seg_output[2]}]
set_property PACKAGE_PIN V5 [get_ports {sev_seg_output[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {sev_seg_output[1]}]
set_property PACKAGE_PIN U7 [get_ports {sev_seg_output[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {sev_seg_output[0]}]
